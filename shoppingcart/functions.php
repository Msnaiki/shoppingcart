...
function send_order_details_email($email, $products, $first_name, $last_name, $address_street, $address_city, $address_state, $address_zip, $address_country, $subtotal, $order_id) {
	...
	mail($email, $subject, $order_details_template, $headers, '-f ' . mail_from);
}
...
<html>
	...
	<body>
        ...
        <img src="imgs/e.gif" alt="logo" style = " width : 60px; height :60 px; margins : 0 10px; border-radius: 60px; ">
